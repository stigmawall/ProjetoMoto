...
public class Road : MonoBehaviour {
	...
	void Update () 
	{
		...
		if( original.z<=inicialZ-80 ) {
			
			GameObject prefab = (GameObject)RoadControl.GenerateRoad();
			GameObject road = Instantiate( prefab, new Vector3(0,0,120), Quaternion.identity );
			Destroy( this );
		}
	}
}
